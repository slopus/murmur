...
function decodeUint16Vector(reader: Reader): readonly number[] {
...
function decodeCredential(reader: Reader): MlsBasicCredential {
...
function decodeCapabilities(reader: Reader): void {
...
function decodeLeafNode(reader: Reader): MlsKeyPackageLeafNode {
