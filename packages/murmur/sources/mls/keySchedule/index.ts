...
import { zeroBytes } from "../internal.js";
 ...
 *
 * Group creation has no joiner or member secret, so those construction-only
 * fields are represented by zero arrays and are erased with the key-schedule
