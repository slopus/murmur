...
describe("State serialization", () => {
    it("should serialize and deserialize empty state", () => {
        ...
        expect(constantTimeEqual(deserialized.dhSelf.privateKey, state.dhSelf.privateKey)).toBe(
            true,
        );
    ...
    it("should serialize and deserialize full state", () => {
        ...
        expect(constantTimeEqual(deserialized.receivingChainKey!, state.receivingChainKey!)).toBe(
            true,
        );
