        ...
        switch (request.params.name) {
            ...
            case "messages.sync": {
                ...
                const newMessages = result.newMessages
                    .filter((message) =>
                        filterIdentity ? message.conversationId === filterIdentity : true,
                    )
            ...
            case "messages.list": {
                ...
                const messages = engine
                    .getMessages(contact.identityKey, limit)
                    .map((message) => formatMessage(message, contacts, profileId));
            ...
            case "publicProfile.commit": {
                ...
                const avatar =
                    typeof avatarImage === "string" && typeof avatarThumbhash === "string"
