...
describe("Full end-to-end encrypted messaging flow", () => {
    ...
    it("should complete full registration and messaging flow", async () => {
        ...
        expect(bytesToString(decrypted.plaintext)).toBe(
