...
describe.skipIf(!LIVE_TEST_ENABLED)("Live Server Integration Tests", () => {
    ...
    describe("Authentication", () => {
        ...
        it("should fail login for non-existent user", async () => {
            ...
            await expect(api.login(identity.publicKey, identity.privateKey)).rejects.toThrow();
        });
    ...
    describe("Profile", () => {
        ...
        it("should fail to get non-existent user profile", async () => {
            ...
            await expect(api.getProfile(fakeProfile.profilePublicKey)).rejects.toThrow();
        });
    ...
    describe("PreKeys", () => {
        ...
        it("should fail to get bundle for user without prekeys", async () => {
            ...
            await expect(api2.getPreKeyBundle(identity.publicKey)).rejects.toThrow();
        });
        ...
        it("should reject prekeys with invalid signature", async () => {
            ...
            await expect(api.uploadPreKeys(preKeys)).rejects.toThrow();
        });
    });
    ...
    describe("Error Handling", () => {
        it("should reject requests without authentication", async () => {
            // API without auth
            await expect(api.getMyProfile()).rejects.toThrow("Not authenticated");
        });
