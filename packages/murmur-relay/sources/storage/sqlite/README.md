...
Topic deletion cascades to snapshots, list elements, and retained events. Blobs
are independent permanent objects. Small event ID receipts live until their
topic is deleted, so pruning the event body never weakens idempotency.
