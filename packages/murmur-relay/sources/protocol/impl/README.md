...
Strict identity-queue delivery, read, acknowledgement, and directory codecs
plus canonical Ed25519 signing bytes. Every decoder rejects unknown fields and
non-canonical base64url or integer representations.
